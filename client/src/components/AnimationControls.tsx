    ...
    <div className="flex items-center gap-3 p-3 bg-card border border-card-border rounded-md shadow-lg">
      ...
      <div className="flex-1 flex items-center gap-3">
        ...
        <Slider
          ...
          step={0.5}
          dir="ltr"
          className="flex-1 [&_[role=slider]]:h-6 [&_[role=slider]]:w-6 [&_[role=slider]]:border-2 [&_[role=slider]]:border-white [&_[role=slider]]:bg-primary [&_[role=slider]]:shadow-xl [&>span:first-child]:h-4 [&>span:first-child]:rounded-full [&>span:first-child]:bg-muted-foreground/40 [&>span:first-child>span]:h-4 [&>span:first-child>span]:rounded-full [&>span:first-child>span]:bg-primary"
